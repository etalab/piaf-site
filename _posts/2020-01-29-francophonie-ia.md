...
Depuis la sortie initiale de cet article, certaines choses ont évolué. Tout d'abord, nous ne sommes plus seuls sur la scène française de jeux de données Question-Réponse! En effet,[Illuin Techonology](https://www.illuin.tech/en/) a publié [FQuAD](https://arxiv.org/abs/2002.06071), un jeu de données de type SQuAD avec la participation de locuteurs natifs français. Ensuite, notre article PIAF a été accepté pour publication à LREC-2020. Malheureusement, en raison du contexte de pandémie mondiale, la conférence a été annulée. La publication de notre article sera toutefois maintenue en mai avec les autres travaux de la conférence. Cet article présente le résultat de nos expériences avec PIAF et FQuAD et bien que différents, nous pensons que les deux jeux de données sont complémentaires. Vous pouvez trouver la version du jeu de données PIAF utilisée pour effectuer ces expériences [ici](https://github.com/etalab-ia/piaf-code/blob/master/piaf-v1.0.json).
