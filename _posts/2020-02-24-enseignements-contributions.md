...
Vous l'aurez compris, PIAF c'est d'abord générer des questions-réponses en français de manière contributive. Pour cela, nous avons mis en place une [plateforme d'annotation](https://github.com/etalab/piaf) qui permette à tout contributeur de proposer des questions et des réponses sur un texte.
...
* [Notre plateforme](https://github.com/etalab/piaf) n'était pas assez robuste et auto-porteuse pour être directement diffusée auprès du grand public. Maintenant c'est le cas !
...
Vous avez un avis ? Des idées ? Vous voulez tester PIAF ? -> Vous pouvez désormais utiliser notre outil open-source [github.com/etalab/piaf](https://github.com/etalab/piaf).
